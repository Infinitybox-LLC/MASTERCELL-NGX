/*
 * FILE: eeprom_init_customer.c
 * Custom Configururation based on Standard Front Engine Configuration for MASTERCELL NGX
 * 
...
void EEPROM_LoadCustomer(void) {
    ...
    // Byte 22-23: Serial Number (0x42) + Customer Name 1 (0x43 'C')
    EEPROM_WriteBytePair(0x0016, DEFAULT_SERIAL_NUMBER, 0x43);
    
    // Byte 24-25: Customer Name 2 (0x55 'U') + Customer Name 3 (0x53 'S')
    EEPROM_WriteBytePair(0x0018, 0x55, 0x53);
