/*
 * FILE: eeprom_init_rear_engine.c
 * Standard Front Engine Configuration for MASTERCELL NGX
 * 
 * This contains the complete Rear Engine configuration that was
...
void EEPROM_LoadRearEngine(void) {
    ...
    // Byte 22-23: Serial Number (0x42) + Customer Name 1 (0x52 'R')
    EEPROM_WriteBytePair(0x0016, DEFAULT_SERIAL_NUMBER, 0x52);
    
    // Byte 24-25: Customer Name 2 (0x45 'E') + Customer Name 3 (0x41 'A')
    EEPROM_WriteBytePair(0x0018, 0x45, 0x41);
    
    // Byte 26-27: Customer Name 4 (0x52 'R') + Reserved (0xFF)
    EEPROM_WriteBytePair(0x001A, 0x52, 0xFF);
